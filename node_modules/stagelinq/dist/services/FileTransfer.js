...
(function (MessageId) {
    ...
    MessageId[MessageId["ServiceDisconnect"] = 9] = "ServiceDisconnect";
})(MessageId || (MessageId = {}));
class FileTransfer extends Service_1.Service {
    ...
    parseData(p_ctx) {
        ...
        switch (messageId) {
            ...
            default:
                {
                    assert_1.strict.fail(`File Transfer Unhandled message id '${messageId}'`);
                }
                break;
        }
    }
            ...
            try {
                await new Promise(async (resolve, reject) => {
                    ...
                    while (this.receivedFile && this.receivedFile.isEOF() === false) {
                        ...
                        LogEmitter_1.Logger.debug(`Reading ${p_location} progressComplete=${Math.ceil(percentComplete)}% ${bytesDownloaded}/${total}`);
