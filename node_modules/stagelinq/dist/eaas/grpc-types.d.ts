 ...
 * License: MIT
 */
export declare enum LibraryLogo {
...
export declare enum SearchFilterField {
...
export type LibraryEvent = {
    type: 'playlistHierarchyChanged';
    event: EventPlaylistHierarchyChanged;
} | {
    type: 'playlistsContentChanged';
    event: EventPlaylistsContentChanged;
} | {
    type: 'trackMetadataChanged';
    event: EventTrackMetadataChanged;
} | {
    type: 'trackPerformanceDataChanged';
    event: EventTrackPerformanceDataChanged;
};
...
export declare enum CreateTrustBusyReason {
...
export type CreateTrustResponse = {
    status: 'granted';
    granted: CreateTrustGranted;
} | {
    status: 'denied';
    denied: CreateTrustDenied;
} | {
    status: 'busy';
    busy: CreateTrustBusy;
};
